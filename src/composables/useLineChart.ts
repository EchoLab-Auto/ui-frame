...
import { buildSmoothPath, type Vec2 } from './chartPath'
...
// Catmull-Rom smoothing helpers (Vec2 / catmullRomToBezier / buildSmoothPath)
// are shared with useCandlestickChart via ./chartPath.
