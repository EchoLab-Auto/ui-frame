...
```vue
<script setup>
import { DocViewer, parseFrontmatter, buildDocTree } from '@echolab-auto/ui-frame/doc'
...
import { useSelect } from '@echolab-auto/ui-frame/composables/useSelect'
import { useTheme } from '@echolab-auto/ui-frame/composables/useTheme'
```

### 按需引入工具函数

```ts
import { debounce } from '@echolab-auto/ui-frame/utils'
import { generateId } from '@echolab-auto/ui-frame/utils'
```

### 按需引入扩展系统

```ts
import { ComponentRegistry } from '@echolab-auto/ui-frame/extensions'
```
